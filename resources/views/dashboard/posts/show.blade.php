...
@section('content')
    @forelse($posts as $post)
                ...
                @if(auth()->user()->id == $post->user_id)
                    <div class="float-end">
                        <a href="#" class="btn btn-sm btn-success" data-bs-toggle="modal"
                           data-bs-target="#commentUpdate{{$post->id}}">
                        ...
                        <a href="#" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                           data-bs-target="#commentDelete{{$post->id}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div class="modal fade" id="commentDelete{{$post->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{route('comments.destroy', $post->id)}}" class="btn btn-primary">Delete</a>
                    </div>
                </div>
            </div>
        </div>
        <!-- Modal Update Comment -->
        <div class="modal fade" id="commentUpdate{{$post->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form id="commentUpdate" action="{{route('comments.update')}}" method="post"
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="comment" value="{{old('comment', $post->comment)}}"
                                       class="form-control">
                            </div>
                        </div>
                        <input type="hidden" name="id" value="{{$post->id}}">
